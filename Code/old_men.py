# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 15:35:00 2021

@author: anacs

Explanatory Variable - Old Aged Men
"""
...
data = pd.read_csv(r'Data\old_men.csv', delimiter=';')
...
#Export as CSV
data.to_csv(r'Data\old_men_final.csv', index=False)
