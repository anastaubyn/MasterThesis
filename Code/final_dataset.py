...
fig.suptitle('Histograms for Explanatory Variables', fontsize=20, y=0.98)
axs[-1, -1].axis('off')
axs[-1, -3].axis('off')
...
axs[1, 0].hist(dfinal['Fertility'], color='darkseagreen', bins = 15)
axs[1, 0].set_title('Fertility')
axs[1, 0].spines['right'].set_visible(False)
axs[1, 0].spines['top'].set_visible(False)
axs[1, 1].hist(dfinal['GER'], color='darkseagreen', bins = 15)
axs[1, 1].set_title('GER')
axs[1, 1].spines['right'].set_visible(False)
axs[1, 1].spines['top'].set_visible(False)
axs[1, 2].hist(dfinal['GER_Men'], color='darkseagreen', bins = 15)
axs[1, 2].set_title('GER_Men')
axs[1, 2].spines['right'].set_visible(False)
axs[1, 2].spines['top'].set_visible(False)
axs[2, 0].hist(dfinal['GER_Women'], color='darkseagreen', bins = 15)
axs[2, 0].set_title('GER_Women')
axs[2, 0].spines['right'].set_visible(False)
axs[2, 0].spines['top'].set_visible(False)
axs[2, 1].hist(dfinal['Marriages'], color='darkseagreen', bins = 15)
axs[2, 1].set_title('Marriages')
axs[2, 1].spines['right'].set_visible(False)
axs[2, 1].spines['top'].set_visible(False)
axs[2, 2].hist(dfinal['Men65'], color='darkseagreen', bins = 15)
axs[2, 2].set_title('Men65')
axs[2, 2].spines['right'].set_visible(False)
axs[2, 2].spines['top'].set_visible(False)
axs[3, 0].hist(dfinal['Mental_Health'], color='darkseagreen', bins = 15)
axs[3, 0].set_title('Mental_Health')
axs[3, 0].spines['right'].set_visible(False)
axs[3, 0].spines['top'].set_visible(False)
axs[3, 1].hist(dfinal['Middle_Aged_Women'], color='darkseagreen', bins = 15)
axs[3, 1].set_title('Middle_Aged_Women')
axs[3, 1].spines['right'].set_visible(False)
axs[3, 1].spines['top'].set_visible(False)
axs[3, 2].hist(dfinal['Monthly_Gain'], color='darkseagreen', bins = 15)
axs[3, 2].set_title('Monthly_Gain')
axs[3, 2].spines['right'].set_visible(False)
axs[3, 2].spines['top'].set_visible(False)
axs[4, 0].hist(dfinal['SS_Pensions'], color='darkseagreen', bins = 15)
axs[4, 0].set_title('SS_Pensions')
axs[4, 0].spines['right'].set_visible(False)
axs[4, 0].spines['top'].set_visible(False)
axs[4, 1].hist(dfinal['Total_Doctors'], color='darkseagreen', bins = 15)
axs[4, 1].set_title('Total_Doctors')
axs[4, 1].spines['right'].set_visible(False)
axs[4, 1].spines['top'].set_visible(False)
axs[4, 2].hist(dfinal['Unemployment_Female'], color='darkseagreen', bins = 15)
axs[4, 2].set_title('Unemployment_Female')
axs[4, 2].spines['right'].set_visible(False)
axs[4, 2].spines['top'].set_visible(False)
axs[5, 0].hist(dfinal['Unemployment_Male'], color='darkseagreen', bins = 15)
axs[5, 0].set_title('Unemployment_Male')
axs[5, 0].spines['right'].set_visible(False)
axs[5, 0].spines['top'].set_visible(False)
axs[5, 1].hist(dfinal['Unemployment_Total'], color='darkseagreen', bins = 15)
axs[5, 1].set_title('Unemployment_Total')
axs[5, 1].spines['right'].set_visible(False)
axs[5, 1].spines['top'].set_visible(False)
axs[5, 2].hist(dfinal['Youth_Dependency'], color='darkseagreen', bins = 15)
axs[5, 2].set_title('Youth_Dependency')
axs[5, 2].spines['right'].set_visible(False)
axs[5, 2].spines['top'].set_visible(False)
axs[6, 1].hist(dfinal['Wage_Gap'], color='darkseagreen', bins = 15)
axs[6, 1].set_title('Wage_Gap')
...
fig.suptitle('Boxplots for Dependent and Explanatory Variables', fontsize=20, y=0.92)
